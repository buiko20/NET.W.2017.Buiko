...
namespace PL.Console
{
    internal class Program
    {
        ...
        {
            var id1 = accountService.OpenAccount("Name1", "Surname1", 100, AccountIdService);
            ...
            var id2 = accountService.OpenAccount(AccountType.Platinum, "Name2", "Surname2", 444, AccountIdService);
